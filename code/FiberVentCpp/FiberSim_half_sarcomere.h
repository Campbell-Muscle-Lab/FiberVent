...
public:
    ...
    double t_offset;                /**< offset in nm for titin spring */

    double t_sigma, t_L;            /**< doubles defining parameters in
                                         f = sigma * (exp(x/L) - 1) */

    // Extracellular parameters
    double e_k_stiff;                   /**< double defininging linear stiffness */

    double e_slack_length;              /**< double defining the slack length in nm
                                             for the extracellular component */
