...
//    FiberSim_model(char JSON_model_file_string[], FiberSim_options* set_p_fs_options);
    ...
    double e_k_stiff;                   /**< double defining linear stiffness of
                                             extracellular component */

    double e_sigma;                     /**< double defining passive scaling factor */

    double e_slack_length;                     /**< double defining passive slack length in nm */
...
//    void write_FiberSim_model_to_file(void);
    ...
    */
    ...
    /*
    * a function that simplifies reading doubles from a JSON structure
    */
    void check_and_assign_double(const rapidjson::Value& doc, string tag,
        double* p_double, double default_value);
};