...
This page explains how to simulate 5 seconds of murine cardiovascular function.
...
+ Run the command
  + `python fiberventcpy.py characterize ../../../../demos/getting_started/mouse/setup/setup_human_1.json`
